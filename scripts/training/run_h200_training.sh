...
export CUDA_VISIBLE_DEVICES=0,1,2,3  # Adjust based on your H200 setup
...
EXPERIMENT_NAME=training_diffusiondrive_h200_optimized
...
python $NAVSIM_DEVKIT_ROOT/navsim/planning/script/run_training.py \
    agent=diffusiondrive_h200_agent \
